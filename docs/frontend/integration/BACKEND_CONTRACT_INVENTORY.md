...
| HTTP operations | 26 | 26 (Auth 2, User 7, Deck 6, Card 6, Learning 5) | ✅ |
| Top-level request/response DTO records (excl. enums/nested) | 18 | 18 (Auth 3, User 3, Deck 3, Card 3, Learning 6) | ✅ |
...
**Endpoint status summary (26 total):** `implemented` 24 · `partial` 2 · `planned` 0 · `missing` 0 · `unclear` 0. Every `Status` value in the table below sums to this total exactly. `missing` is reserved for product capabilities with no controller/route at all (see §9).
